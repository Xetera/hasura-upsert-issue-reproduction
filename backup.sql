...
1ba35b1c-ef6d-42bd-a2a3-c0c65061f6de	2020-04-22 00:34:18.183517+00	{"metadata":false,"remote_schemas":[]}
\.
...
COPY public.companies (name, logo, updated_at) FROM stdin;
JYP	\N	2020-04-22 00:29:50.021854+00
\.
...
COPY public.group_aliases (alias, group_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.group_member_roles (id, member_id, role_name) FROM stdin;
\.
...
COPY public.group_members (idol_id, role, group_id, created_at, updated_at, join_date, departure_date, id) FROM stdin;
576	\N	126	2020-04-22 00:34:11.753992+00	2020-04-22 00:34:11.753992+00	\N	\N	600
\.
...
COPY public.groups (name, korean_name, debut, original_member_count, company_name, fandom_name, status, image, banner, id, parent_group_id, spotify_id, youtube_id, vlive_id, twitter_handle, instagram_username, fan_cafe_id, melon_id, type, description, discord_server_id, banner_text, gender, created_at, updated_at) FROM stdin;
TWICE	트와이스	2011-04-18	\N	JYP	\N	ACTIVE	\N	\N	126	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2020-04-22 00:34:11.753992+00	2020-04-22 00:34:11.753992+00
\.
...
COPY public.idols (full_name, native_name, birth_date, gender, country_of_origin, stage_name, id, twitter, instagram, height, image, banner, melon_id, description, zodiac_sign, korean_stage_name, birth_city, weight, thumbnail, created_at, updated_at) FROM stdin;
Park Jihyo	\N	\N	\N	\N	\N	576	\N	\N	\N	\N	\N	\N	\N	\N	Jihyo	\N	\N	\N	2020-04-22 00:26:19.989288+00	2020-04-22 00:32:10.597889+00
Hirai Momo	\N	\N	\N	\N	Momo	577	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2020-04-22 00:26:44.283818+00	2020-04-22 00:32:29.696737+00
\.
...
COPY public.release_songs (date_added, is_title_track, group_id, song_id, release_id, updated_at, created_at) FROM stdin;
\.
...
COPY public.releases (name, release_date, album_cover, type, description, melon_id, genre, group_id, id, spotify_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.songs (name, length, mv_link, spotify_link, language, group_id, id, release_id, melon_id, korean_name, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_refresh_tokens (id, created_at, is_valid, expires_in, user_id, updated_at) FROM stdin;
\.
...
COPY public.users (username, registered_at, updated_at, discord_user_id, discord_username, role, twitter_user_id, bio, avatar, banner, email, locale, id, banned) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.group_members_id_seq', 600, true);
...
SELECT pg_catalog.setval('public.groups_id_seq', 127, true);
...
SELECT pg_catalog.setval('public.idols_id_seq', 577, true);
